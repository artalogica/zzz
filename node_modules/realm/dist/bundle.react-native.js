...
function fromBindingTimeoutSignal(timeoutMs) {
    ...
    return timeout > 0 ? PolyfilledAbortSignal.timeout(timeout) : undefined;
}
...
inject$2({
    ...
    joinPaths(...segments) {
        return pathBrowserify.join(...segments);
    },
    removeFile(path) {
    ...
    ensureDirectoryForFile(path) {
        debug$2("ensureDirectoryForFile", path);
...
function getDeviceName() {
    if (reactNative.Platform.OS === "ios") {
        ...
        else if (reactNative.Platform.isTV) {
            return "AppleTV";
        }
        else {
        ...
        return `${reactNative.Platform.constants.Manufacturer}:${reactNative.Platform.constants.Brand}`;
    }
    else {
        return "unknown";
    }
...
function getDeviceVersion() {
    if (reactNative.Platform.OS === "android") {
        return `${reactNative.Platform.constants.Model}`;
    }
    else {
        return "unknown";
    }
...
//# sourceMappingURL=bundle.react-native.js.map
