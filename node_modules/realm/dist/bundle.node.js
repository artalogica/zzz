...
const nodeRequire = typeof require === "function" ? require : node_module.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('bundle.node.js', document.baseURI).href)));
...
const HTTP_METHOD = {
    [0 /* HttpMethod.Get */]: "GET",
    [1 /* HttpMethod.Post */]: "POST",
    [3 /* HttpMethod.Put */]: "PUT",
    [2 /* HttpMethod.Patch */]: "PATCH",
    [4 /* HttpMethod.Del */]: "DELETE",
};
...
function toFetchArgs({ url, method, timeoutMs, body, headers }) {
    return [
        url,
        {
...
inject$1({
    create() {
        return {
            ...
            bundleId: config?.anonymizedBundleId ,
        };
    },
});
...
/** @internal */
function asyncIteratorFromResponse({ body }) {
...
function toBindingLoggerLevel(arg) {
    const bindingLogLevel = inverseTranslationTable$1[arg];
...
const inverseTranslationTable$1 = Object.fromEntries(Object.entries(translationTable$1).map(([key, val]) => [val, Number(key)]));
/** @internal */
function fromBindingLoggerLevelToLogLevel(arg) {
    return translationTable$1[arg];
}
/** @internal */
...
const translationTable = {
    [0 /* binding.MetadataMode.NoEncryption */]: exports.MetadataMode.NoEncryption,
    [1 /* binding.MetadataMode.Encryption */]: exports.MetadataMode.Encryption,
    [2 /* binding.MetadataMode.NoMetadata */]: exports.MetadataMode.NoMetadata,
};
...
class App {
    ...
    constructor(configOrId) {
        ...
        if (metadata !== undefined) {
            ...
            if (metadata.mode === exports.MetadataMode.Encryption) {
        ...
        this.internal = App$1.getApp(1 /* binding.AppCacheMode.Disabled */, {
            appId: id,
...
class Realm {
    ...
    static List = List;
    static mapTo = mapTo;
    static MetadataMode = exports.MetadataMode;
    static NumericLogLevel = exports.NumericLogLevel;
    ...
    static schemaVersion(path, encryptionKey) {
        ...
        return notFound === schemaVersion.toString() ? -1 : Int64.intToNum(schemaVersion);
    }
    /**
...
function injectInspect(constructor, customInspect) {
    Object.assign(constructor.prototype, { [node_util.inspect.custom]: customInspect });
}
...
function defaultInspector(depth, options) {
    ...
    if (depth === -1) {
        ...
        return `${name} ${node_util.inspect(isIterable(this) ? [...this] : { ...this }, options.showHidden, depth, options.colors)}`;
    }
}
