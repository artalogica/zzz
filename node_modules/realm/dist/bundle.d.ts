...
type AnyFetch = typeof fetch<any, any, any, any>;
...
export { type AggregatePipelineStage, type ApiKey, ApiKeyAuth, App, type AppChangeCallback, type AppConfiguration, type AppServicesFunction, AssertionError, BSON, type BaseChangeEvent, type BaseConfiguration, type BaseObjectSchema, BaseSubscriptionSet, type BaseSyncConfiguration, type CanonicalGeoPoint, type CanonicalGeoPolygon, type CanonicalObjectSchema, type CanonicalObjectSchemaProperty, type CanonicalPropertiesTypes, type CanonicalPropertySchema, type ChangeEvent, type ChangeEventId, type ClientResetAfterCallback, type ClientResetBeforeCallback, type ClientResetConfig, type ClientResetDiscardUnsyncedChangesConfiguration, type ClientResetFallbackCallback, type ClientResetManualConfiguration, ClientResetMode, type ClientResetRecoverOrDiscardUnsyncedChangesConfiguration, type ClientResetRecoverUnsyncedChangesConfiguration, type ClientResetRecoverUnsyncedChangesConfiguration as ClientResetRecoveryConfiguration, Collection, type CollectionChangeCallback, type CollectionChangeSet, type CollectionPropertyTypeName, CompensatingWriteError, type CompensatingWriteInfo, type Configuration, type ConfigurationWithSync, type ConfigurationWithoutSync, type ConnectionNotificationCallback, ConnectionState, type CountOptions, Credentials, type DefaultFunctionsFactory, type DefaultUserProfileData, type DeleteEvent, type DeleteResult, Dictionary, type DictionaryChangeCallback, type DictionaryChangeSet, type Document, type DocumentKey, type DocumentNamespace, type DropDatabaseEvent, type DropEvent, EmailPasswordAuth, type ErrorCallback, type Filter, type FindOneAndModifyOptions, type FindOneOptions, type FindOptions, type FlexibleSyncConfiguration, type GeoBox, type GeoCircle, type GeoPoint, type GeoPolygon, type GeoPosition, type IndexDecorator, type InsertEvent, type InsertManyResult, type InsertOneResult, type InvalidateEvent, List, type LocalAppConfiguration, type LogLevel, type LoggerCallback, type MapToDecorator, type Metadata, MetadataMode, type MigrationCallback, type Mixed, MongoDB, MongoDBCollection, type MongoDBDatabase, MutableSubscriptionSet, type NewDocument, NumericLogLevel, RealmObject as Object, type ObjectChangeCallback, type ObjectChangeSet, type RealmObjectConstructor as ObjectClass, type ObjectSchema, ObjectSchemaParseError, type ObjectSchemaProperty, type ObjectType, type OpenRealmBehaviorConfiguration, OpenRealmBehaviorType, OpenRealmTimeOutBehavior, type OperationType, OrderedCollection, type PartitionSyncConfiguration, type PartitionValue, type PrimaryKey, type PrimitivePropertyTypeName, ProgressDirection, ProgressMode, type ProgressNotificationCallback, ProgressRealmPromise, type PropertiesTypes, type PropertySchema, type PropertySchemaCommon, PropertySchemaParseError, type PropertySchemaShorthand, type PropertySchemaStrict, type PropertyTypeName, ProviderType, ProxyType, Realm, type RealmEventName, type AppServicesFunction as RealmFunction, type RealmObjectConstructor, type RelationshipPropertyTypeName, type RenameEvent, type ReplaceEvent, Results, type SSLConfiguration, type SSLVerifyCallback, type SSLVerifyObject, SchemaParseError, SyncSession as Session, SessionState, SessionStopPolicy, RealmSet as Set, type SortDescriptor, Subscription, type SubscriptionOptions, SubscriptionSet, SubscriptionSetState, SubscriptionsState, Sync, type SyncConfiguration, SyncError, SyncSession, TypeAssertionError, Types, type Update, type UpdateDescription, type UpdateEvent, UpdateMode, type UpdateOptions, type UpdateResult, User, type UserChangeCallback, UserState, type UserTypeName, WaitForSync, Realm as default, flags, index, kmToRadians, mapTo, miToRadians };
