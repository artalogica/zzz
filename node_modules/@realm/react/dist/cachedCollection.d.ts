 ...
 */
export declare function createCachedCollection<T extends Realm.Object<any>>({ collection, realm, updateCallback, updatedRef, objectCache, isDerived, }: CachedCollectionArgs<T>): {
